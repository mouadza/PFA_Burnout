...
import 'admin_users_screen.dart'; // ✅ IMPORT : On pointe vers votre fichier existant
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Tableau de bord Admin', style: TextStyle(color: Colors.black)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // 👋 EN-TÊTE (Style identique au User mais couleur Indigo)
            Container(
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
                color: Colors.indigo.shade800, // Couleur distinctive pour Admin
            ...
            Column(
              children: [
                ...
                // C'est ici qu'on remplace "Questionnaire" par votre gestionnaire
                _ActionCard(
                  title: "Gestion des Utilisateurs",
                  subtitle: "Ajouter, supprimer, modifier les comptes",
                  icon: Icons.manage_accounts,
                  color: Colors.indigo,
                  isLarge: true,
                  onTap: () {
                    // ✅ Navigation vers votre écran AdminUsersScreen
                    Navigator.push(
                      context,
                      MaterialPageRoute(
...
// Widget local pour les cartes (réutilisé)
